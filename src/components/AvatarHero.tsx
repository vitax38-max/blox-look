...
import { RobloxUserDetail, RobloxThumbnails } from "../types";
            ...
            <div className="flex flex-wrap items-start justify-between gap-4">
              <div>
                ...
                <div className="mt-1 flex items-center gap-3">
                  <span className="font-mono text-sm text-zinc-400">@{user.name}</span>
            ...
            <div className="mt-6 grid grid-cols-2 gap-3 sm:grid-cols-4">
              ...
              <div className="rounded-2xl border border-amber-500/20 bg-amber-950/20 p-3">
                <div className="flex items-center gap-1.5 text-xs text-amber-300">
                  ...
                  <span>Est. Fit Cost</span>
                </div>
                <div className="mt-1 text-sm font-bold text-amber-300">
                  {totalRobux > 0 ? `${totalRobux.toLocaleString()} R$` : "Catalog Fit"}
                </div>
                <div className="text-[11px] text-amber-400/80">Equipped items</div>
              </div>
            </div>
